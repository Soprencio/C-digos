...
def click(i,j):
    ...
    if(vecant[0]!=0):
        ...
        vecant[1]=i
        vecant[2]=j
        matimg[vecant[2]][vecant[1]].configure(image=imagenzoom[matnum[i][j]])
        ventana.update()
        if(matnum[vecant[1]][vecant[2]]==matnum[vecant[3]][vecant[4]]):
            matimg[vecant[2]][vecant[1]].configure(state='disable')
            matimg[vecant[4]][vecant[3]].configure(state='disable')
            vecant[6]+=1
            if(vecant[6]==16):
        ...
        vecant[3]=i
        vecant[4]=j
        matimg[vecant[4]][vecant[3]].configure(image=imagenzoom[matnum[i][j]])
        ventana.update()
