...
'''Hacer un programa que permita ingresar una cadena de caracteres y una letra y muestre la cantidad de veces que la letra ingresada aparece en la palabra y las posiciones
que ocupan.'''
